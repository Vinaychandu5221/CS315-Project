                ...
                <div class="card wish-list mb-3">
                    <div class="pt-4 border bg-light rounded p-3">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0 bg-light">Hotel Charges<span><?php echo $hotelPrice ?></span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0 bg-light">Booking Charges<span>Rs. 500</span></li>

                            <li class="list-group-item d-flex justify-content-between align-items-center px-0 bg-light">GST Tax (10%)<span>Rs.  <?php echo $totalPrice ?></span></li>
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mb-3 bg-light">
                                <div>
                                    <strong>Total Amount</strong>
                                </div>
                                <span><strong>Rs. <?php echo $finalPrice ?></strong></span>
                            </li>
                        </ul>
                        <br>
